...
<div class="increase-gallery increase-gallery-slick-slider">
    ...
    */
    ...
    <div id="slickid-<?php echo the_field('id_slick') ?>" class="increase-gallery-item thumb-bg">
        <img class="fixed-middle d-none d-sm-block" src="<?php echo the_field('fixed_middle_image'); ?>">
        <div class="row no-gutters">
            ...
            <div class="col-12 col-sm-6 background-style" style="background-image:url(<?php echo the_field('left_image'); ?>)">
                ...
                <?php if( get_field('slider_video') ) { ?>
                    ...
                    <div class="dynamic-desktop-padding"></div>


                </div>

                <div class="col-12 col-sm-6 background-style backgroud-style-dynamic-padding" style="background-image:url(<?php echo the_field('right_image') ?>)">
...
jQuery(document).ready(function($){
    ...
    // jQuery(".absolute-content").css("padding-bottom", dynamicPx + 50 + "px");
...
// jQuery("img.fixed-middle").css("top", dynamicPx + "%");
    ...
    // jQuery("img.fixed-middle").css("top", dynamicPx + "%");
        ...
        //jQuery(".dynamic-height").css("height", dynamicPx + "px");
         jQuery(".dynamic-height").css("height", "100%");
         jQuery(".dynamic-padding").css("padding-bottom", dynamicPx + 250  +  "px");
        // jQuery(".absolute-content").css("padding-bottom", dynamicPx + 50 + "px");
         jQuery(".backgroud-style-dynamic-padding").css("padding-bottom", dynamicPx + 100 + "px");
